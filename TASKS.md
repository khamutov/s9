...
- [ ] **0.9** Shared stylesheet → `prototypes/style.css`
...
- [ ] **0.14** Layout shell → `prototypes/05-layout.html` [blocked by: 0.9]
- [ ] **0.15** Milestone view → `prototypes/06-milestone-view.html` [blocked by: 0.9]
...
- [ ] **2.1** DB connection pool + migration runner [blocked by: 0.1, 1.1]
- [ ] **2.2** Configuration loading (CLI args, env vars, config file) [blocked by: 1.1]
- [ ] **2.3** Database schema migrations (all tables) [blocked by: 0.1, 2.1]
- [ ] **2.4** Domain models (Rust structs with serde) [blocked by: 2.3]
...
- [ ] **3.1** Password hashing (argon2) [blocked by: 0.3]
- [ ] **3.2** Session management [blocked by: 0.3, 2.5]
